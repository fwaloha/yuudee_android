...
public class PreferencesHelper {
    ...
    private static final String QCELLCOREID = "QCELLCOREID";


    public String getSaveSex() {

        return getString(SEXNAME, SEXNAME, "");

    }

    public void saveSex(String savesex) {
        saveString(SEXNAME, SEXNAME, savesex);
    }
...
//		LogOut.e("saveString:", commit+",key:"+key);
    ...
    public String getSmsCode() {
        return mPref.getString(SMSCODE, "86");
    }
    ...
    public void savePhto(String photo) {
        mPref.edit().putString(PHOTO, photo).apply();
    }

    public String getPhoto() {
        return mPref.getString(PHOTO, "");
    }

    public void saveQcellCoreId(String qcellcore) {
        mPref.edit().putString(QCELLCOREID, qcellcore).apply();
    }

    public String getQcellCoreId() {
        return mPref.getString(QCELLCOREID, "1");
    }
    ...
    public void saveIsRemind(String isremind) {
        mPref.edit().putString(ISREMIND, isremind).apply();
    }

    public String getIsremind() {
        return mPref.getString(ISREMIND, "");
    }
