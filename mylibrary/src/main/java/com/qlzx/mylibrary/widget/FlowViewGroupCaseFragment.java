...
public class FlowViewGroupCaseFragment extends ViewGroup {
    private static final String TAG = "zxt/FlowViewGroup";

    public FlowViewGroupCaseFragment(Context context) {
        this(context, null);
    }

    public FlowViewGroupCaseFragment(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowViewGroupCaseFragment(Context context, AttributeSet attrs, int defStyleAttr) {
