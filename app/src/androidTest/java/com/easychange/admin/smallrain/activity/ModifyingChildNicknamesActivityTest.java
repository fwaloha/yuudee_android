...
public class ModifyingChildNicknamesActivityTest {

    @Rule
    public ActivityTestRule<ModifyingChildNicknamesActivity> mActivityRule =
            new ActivityTestRule<>(ModifyingChildNicknamesActivity.class);
