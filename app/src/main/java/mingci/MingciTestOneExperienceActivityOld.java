...
public class MingciTestOneExperienceActivityOld extends BaseActivity implements View.OnClickListener, AsyncRequest {
    ...
    public void RequestComplete(Object object, Object data) {
        if (object.equals(22)) {//标记那个接口
            ...
            (MingciTestOneExperienceActivityOld.this).runOnUiThread(new Runnable() {//在UI线程处理逻辑，当操作控件的时候
                @Override
                public void run() {
            ...
            (MingciTestOneExperienceActivityOld.this).runOnUiThread(new Runnable() {//在UI线程处理逻辑，当操作控件的时候
                ...
                public void run() {
                    ...
                    try {
                        ...
                        ToastUtil.showToast(MingciTestOneExperienceActivityOld.this, msg1);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new PreferencesHelper(MingciTestOneExperienceActivityOld.this);
...
//                  preferencesHelper.saveIsBackground(false);
    ...
    private void parentsAddRecord(String type) {
        PreferencesHelper helper = new PreferencesHelper(MingciTestOneExperienceActivityOld.this);
        ...
        OkHttpUtils
                ...
                .id(22)//XX接口的标识
                .build()
                .execute(new BaseStringCallback_Host(MingciTestOneExperienceActivityOld.this, this));
    }
    ...
    private void initView() {
        ...
        int grapWidth = MyUtils.dip2px(MingciTestOneExperienceActivityOld.this, 26);
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (i == 0) {
                GlideUtil.display(MingciTestOneExperienceActivityOld.this, nounTestBean.getList().get(0).getCardColorImage(), iv_click_pic);
            } else if (i == 1) {
                GlideUtil.display(MingciTestOneExperienceActivityOld.this, nounTestBean.getList().get(1).getCardColorImage(), iv_click_pic);
            }
        }
...
//                把小手的布局隐藏掉
                                    ...
                                    public void run() {
                                        ...
                                        if (!isOrder) {
                                            if (pass.equals("1")) {//是否通过 1 是 0 否
                                                ...
                                                int i = tiankongkuangTop - moneyTop - MyUtils.dip2px(MingciTestOneExperienceActivityOld.this, 32);

                                                int screenWidth = MyUtils.getScreenWidth(MingciTestOneExperienceActivityOld.this) / 3;
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                //缩放
                Animation animation = AnimationUtils.loadAnimation(MingciTestOneExperienceActivityOld.this, R.anim.anim_scale_pic);
    ...
    public void onBackPressed() {
        ...
        OkHttpUtils.getInstance().cancelTag(MingciTestOneExperienceActivityOld.this);
        super.onBackPressed();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_home:
                ...
                Intent intent = new Intent(MingciTestOneExperienceActivityOld.this, MainActivity.class);
    ...
    private void mergeText() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                llTextParent.setBackgroundColor(MingciTestOneExperienceActivityOld.this.getResources().getColor(R.color.white));
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (position < model.getNounTest().size()) {
                                    ...
                                    Intent intent = new Intent(MingciTestOneExperienceActivityOld.this, MingciTestOneExperienceActivityOld.class);
...
//                                    8.	体验产品时，做完一组训练与测试，笑脸满足10个就进入强化物后返回首页，没有笑脸满足10个直接返回首页
                                    ...
                                    if (anInt >= 10) {
                                        Intent intent = new Intent(MingciTestOneExperienceActivityOld.this, PinTuTiYanActivity.class);
