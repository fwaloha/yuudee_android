...
public class SendSmsTimerUtils extends CountDownTimer {//验证码倒计时的工具类
    ...
    * */
     ...
     * @param normalColor
     * @param afterColor
     * @param typecolor     1 的时候是白色 ，2的时候是金色
     */
    public static void sendSms(TextView view, int normalColor, int afterColor,int typecolor) {
        type = typecolor;
    ...
    public void onTick(long millisUntilFinished) {
        ...
        int color = MyApplication.getGloableContext().getResources().getColor(R.color.textgrey);
    ...
    public void onFinish() {
        ...
        int color = 1;
        if (type==1){
            color = MyApplication.getGloableContext().getResources().getColor(R.color.white);
        }else if (type ==2){
            color = MyApplication.getGloableContext().getResources().getColor(R.color.text_tu);
        }
        mTextView.setTextColor(color);
