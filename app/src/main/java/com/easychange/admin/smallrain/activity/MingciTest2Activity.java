...
//                笔消失动画
        AnimationHelper.startPaintGoneAnimation(MingciTest2Activity.this, ll_choose2);
        AnimationHelper.startPaintGoneAnimation(MingciTest2Activity.this, ll_choose4);
        ...
        tvPaint.post(new Runnable() {
            ...
            public void run() {
                ...
                int i = (MyUtils.dip2px(MingciTest2Activity.this, 190) - (tvPaint.getWidth() + tvContent.getWidth())) / 2;
                int paintX = MyUtils.dip2px(MingciTest2Activity.this, 85) - tvPaint.getWidth();
                int contentX = MyUtils.dip2px(MingciTest2Activity.this, 85 - 20) - tvContent.getWidth();
                ...
                tr2.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        ...
                        aa.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation animation) {
                                if (position == 0) {
                                    Intent intent = new Intent(MingciTest2Activity.this, MingciTest2Activity.class);
                                    ...
                                    Intent intent = new Intent(MingciTest2Activity.this, PinTuActivity.class);
                                    startActivity(intent);
                                }
                                finish();
                            }
