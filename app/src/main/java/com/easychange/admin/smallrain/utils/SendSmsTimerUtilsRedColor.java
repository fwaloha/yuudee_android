...
public class SendSmsTimerUtilsRedColor extends CountDownTimer {//验证码倒计时的工具类
    /*
    ...
    * */
    ...
    public static void sendSms(TextView view, int normalColor, int afterColor) {
        SendSmsTimerUtilsRedColor mCountDownTimerUtils = new SendSmsTimerUtilsRedColor(view, 60000, 1000, normalColor, afterColor);
     ...
     */
    private SendSmsTimerUtilsRedColor(TextView textView, long millisInFuture, long countDownInterval,
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setText("重新获取验证码("+millisUntilFinished / 1000 + ")");
...
//        mTextView.setTextColor(MyApplication.getGloableContext().getResources().getColor(R.color.text_code));
        mTextView.setTextColor(Color.parseColor("#c06d00"));
