 ...
 * describe:  句子分解页面
 */
public class JuZiDecomposeActivityFourClick extends BaseActivity {
    ...
    private int currentPracticePosition = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentPracticePosition == 0) {
            chiDangaoAnim(R.drawable.heigouchi1, R.drawable.heigouchi2, R.drawable.heigouchi3);
        ...
        if (currentPracticePosition == 0) {
            tv_content1.setText("黑");
            tv_content2.setText("狗");
            tv_content3.setText("吃");
            tv_content4.setText("骨头");
        } else if (currentPracticePosition == 1) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (i == 0) {
                if (currentPracticePosition == 0) {
                    iv_click_pic.setImageDrawable(JuZiDecomposeActivityFourClick.this.getResources().getDrawable(R.drawable.gutou));//
                } else if (currentPracticePosition == 1) {
                    iv_click_pic.setImageDrawable(JuZiDecomposeActivityFourClick.this.getResources().getDrawable(R.drawable.binggan));//
                }

            } else if (i == 1) {

                if (currentPracticePosition == 0) {
                    iv_click_pic.setImageDrawable(JuZiDecomposeActivityFourClick.this.getResources().getDrawable(R.drawable.xiaoheigou));//
                } else if (currentPracticePosition == 1) {
                    iv_click_pic.setImageDrawable(JuZiDecomposeActivityFourClick.this.getResources().getDrawable(R.drawable.nan));//
                }
...
//                iv_click_pic.setImageDrawable(JuZiExerciseActivityFourClick.this.getResources().getDrawable(R.drawable.chi1));//
                ...
                if (currentPracticePosition == 0) {
                    iv_click_pic.setImageDrawable(JuZiDecomposeActivityFourClick.this.getResources().getDrawable(R.drawable.baigou));//
                } else if (currentPracticePosition == 1) {
                    iv_click_pic.setImageDrawable(JuZiDecomposeActivityFourClick.this.getResources().getDrawable(R.drawable.hai));//
                }
        ...
        if (currentPracticePosition == 0) {
            tv_content11.setText("骨头");
            tv_content22.setText("黑");
            tv_content33.setText("吃");
            tv_content44.setText("狗");
        } else if (currentPracticePosition == 1) {
...
//                位置和长度的单位是像素。
                ...
                ll_text_parent.setBackgroundColor(JuZiDecomposeActivityFourClick.this.getResources().getColor(R.color.white));
...
//                            chiDangaoAnim(R.drawable.chidanggao11, R.drawable.chidanggao2, R.drawable.chidanggao3);
                            playLocalVoice("男-黑狗吃骨头.MP3", false);
                        } else if (currentPracticePosition == 1) {
                            chiDangaoAnim(R.drawable.bingan1, R.drawable.bingan2, R.drawable.bingan3);
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (currentPracticePosition < 2) {
                                    Intent intent = new Intent(JuZiDecomposeActivityFourClick.this, JuZiDecomposeActivityFourClick.class);
                                    intent.putExtra("currentPracticePosition", currentPracticePosition);
                                    startActivity(intent);
                                    finish();
                                } else {
                                    Intent intent = new Intent(JuZiDecomposeActivityFourClick.this, PinTuActivity.class);
                                    startActivity(intent);
                                    finish();
                                }
