 ...
 * 分解是4个卡片
 */
public class JuZiChengZuXunLianActivityOld extends BaseActivity implements AsyncRequest {
...
//        应该是做题的时候，中途退出，20分钟内，进来的时候，显示的刚才的做题位置，如果超过20分钟就从第一个课件开始做
    ...
    private void getVerb() {
        ...
        OkHttpUtils
                ...
                .url(url)//接口地址
                .id(1)//XX接口的标识
                .tag(JuZiChengZuXunLianActivityOld.this)
                .build()
                .execute(new BaseStringCallback_Host(JuZiChengZuXunLianActivityOld.this, this));
    }
    ...
    public void RequestComplete(Object object, Object data) {
        if (object.equals(1)) {//标记那个接口
            ...
            (JuZiChengZuXunLianActivityOld.this).runOnUiThread(new Runnable() {//在UI线程处理逻辑，当操作控件的时候
                @Override
                public void run() {
...
//                                scene	是	string	学习场景 1训练 2测试 3意义
                                if (scene.equals("1")) {
                                    ...
                                    Intent intent = new Intent(JuZiChengZuXunLianActivityOld.this, JuZiChengZuCiShiLianActivity.class);
                    ...
                    try {
                        ...
                        if (code.equals("200")) {
                            ...
                            if (position < juzibean.getSentenceGroupTraining().size()) {
                                ...
                                Intent intent = new Intent(JuZiChengZuXunLianActivityOld.this,
                                        JuZiChengZuXunLianActivityOld.class);
                                intent.putExtra("groupId", groupId);
                                ...
                                Intent intent = new Intent(JuZiChengZuXunLianActivityOld.this, LetsTestActivity.class);
...
//    句子分解 训练helptime里的helptime 测试cardOneTime,cardTwoTime,cardThreeTime,cardFourTime
    private void setDataIntoView() {
        ...
        int grapWidth = MyUtils.dip2px(JuZiChengZuXunLianActivityOld.this, 26);
        for (int i = 0; i < currentSize; i++) {
            View inflate = LayoutInflater.from(JuZiChengZuXunLianActivityOld.this).inflate(R.layout.text_bg_big, null);
            if (i == 0) {
        ...
        for (int i = 0; i < currentSize; i++) {
            View inflate = LayoutInflater.from(JuZiChengZuXunLianActivityOld.this).inflate(R.layout.text_layout_big, null);
            if (i == 0) {
...
//            View inflate = LayoutInflater.from(JuZiChengZuXunLianActivity.this).inflate(R.layout.click_layout_two_click_pic, null);
            ...
            if (!contains) {
                GlideUtil.display(JuZiChengZuXunLianActivityOld.this, cardImage, iv_click_pic);
            } else {
    ...
    private void mergeText() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                llTextParent.setBackgroundColor(JuZiChengZuXunLianActivityOld.this.getResources().getColor(R.color.white));
...
//            player.start();
    ...
    private void addTrainingResult(String coursewareId, String startTime
        ...
        PreferencesHelper helper = new PreferencesHelper(JuZiChengZuXunLianActivityOld.this);
