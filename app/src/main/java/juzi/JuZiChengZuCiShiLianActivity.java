 ...
 * 分解是4个卡片
 */
public class JuZiChengZuCiShiLianActivity extends BaseActivity implements AsyncRequest {
    ...
    private void setDataIntoView() {
        ...
        int grapWidth = MyUtils.dip2px(JuZiChengZuCiShiLianActivity.this, 26);
        for (int i = 0; i < currentSize; i++) {
            View inflate = LayoutInflater.from(JuZiChengZuCiShiLianActivity.this).inflate(R.layout.text_bg_big, null);
            if (i == 0) {
        ...
        for (int i = 0; i < currentSize; i++) {
            View inflate = LayoutInflater.from(JuZiChengZuCiShiLianActivity.this).inflate(R.layout.text_layout_big, null);
            if (i == 0) {
...
//            View inflate = LayoutInflater.from(JuZiChengZuCiShiLianActivity.this).inflate(R.layout.click_layout_two_click_pic, null);
            ...
            if (!contains) {
                GlideUtil.display(JuZiChengZuCiShiLianActivity.this, cardImage, iv_click_pic);
            } else {
                                    ...
                                    public void run() {
                                        if (!isOrder) {
                                            ...
                                            if (pass.equals("1")) {//是否通过 1 是 0 否
                                                ...
                                                int i = tiankongkuangTop - moneyTop - MyUtils.dip2px(JuZiChengZuCiShiLianActivity.this, 32);

                                                int screenWidth = MyUtils.getScreenWidth(JuZiChengZuCiShiLianActivity.this) / 3;
...
//                                            }
    ...
    private void addTrainingResult(String coursewareId, String startTime
        ...
        PreferencesHelper helper = new PreferencesHelper(JuZiChengZuCiShiLianActivity.this);
        ...
        OkHttpUtils
                ...
                .url(url)//接口地址
                .id(2)//XX接口的标识
                .tag(JuZiChengZuCiShiLianActivity.this)
                .build()
                .execute(new BaseStringCallback_Host(JuZiChengZuCiShiLianActivity.this, this));
    ...
    public void RequestComplete(Object object, Object data) {
        if (object.equals(2)) {//标记那个接口
            ...
            (JuZiChengZuCiShiLianActivity.this).runOnUiThread(new Runnable() {//在UI线程处理逻辑，当操作控件的时候
                @Override
                public void run() {
                    ...
                    try {
                        ...
                        if (code.equals("200")) {
                            ...
                            if (position < juzibean.getSentenceGroupTraining().size()) {
                                ...
                                Intent intent = new Intent(JuZiChengZuCiShiLianActivity.this, JuZiChengZuCiShiLianActivity.class);
...
//                                    名词,动词,句子分解通关,进入通关成功的页面,3S返回首页  句子分组通关后进入通关成功的页面3S自动进入句子分解模块
                                    ...
                                    Intent intent1 = new Intent(JuZiChengZuCiShiLianActivity.this, PinTuAllFlyActivity.class);
                                ...
                                if (gold >= 10) {//达到了10个金币
                                    Intent intent = new Intent(JuZiChengZuCiShiLianActivity.this, PinTuActivity.class);
                                    ...
                                    Intent intent = new Intent(JuZiChengZuCiShiLianActivity.this, LetsTestToTrainActivity.class);
    ...
    private void mergeText() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                playLocalVoiceOnLineGroupVoice(sentenceGroupTrainingBean.getGroupRecord());
                ...
                llTextParent.setBackgroundColor(JuZiChengZuCiShiLianActivity.this.getResources().getColor(R.color.white));
